...
const styles = StyleSheet.create({
  ...
  preview: { fontSize: 13, letterSpacing: 0.1, opacity: 0.65 },
  time: { fontSize: 10, letterSpacing: 0.2, opacity: 0.60 },
  membersBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10 },
  members: { fontSize: 10, letterSpacing: 0.3 },
});
